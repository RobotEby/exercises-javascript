...
// Exercício 2
const accountBank = ['Oliva', 'Nat', 'Gus'];
...
console.log(addCustomers(accountBank, ['Carolina', 'Adamastor']));
console.log(addCustomers(accountBank, ['Miranda', 78]));